...
from sql_functions.sql_alchemy_funcs import Corr, my_session_fabric
...
def get_corr_by_filter(
    ...
    is_container_train: str = Query(
        None, description="Признак контейнерного поезда (1/0)"
    ),
    ...
    specific_van_for_coal_id: str = Query(
        None, description="Идентификатор специального вагона для угля"
    ),
    mainland_payment_by_loaded_carriage: str = Query(
        None, description="Тариф за груженый вагон (материк)"
    ),
    sakhalin_payment_by_loaded_carriage: str = Query(
        None, description="Тариф за груженый вагон (Сахалин)"
    ),
    crimea_payment_by_loaded_carriage: str = Query(
        None, description="Тариф за груженый вагон (Крым)"
    ),
    kazakhstan_payment_by_loaded_carriage: str = Query(
        None, description="Тариф за груженый вагон (Казахстан)"
    ),
    litva_payment_by_loaded_carriage: str = Query(
        None, description="Тариф за груженый вагон (Литва)"
    ),
    belarus_payment_by_loaded_carriage: str = Query(
        None, description="Тариф за груженый вагон (Беларусь)"
    ),
    zhdn_payment_by_loaded_carriage: str = Query(
        None, description="Тариф за груженый вагон (ЖДН)"
    ),
    mainland_payment_by_empty_carriage: str = Query(
        None, description="Тариф за порожний вагон (материк)"
    ),
    sakhalin_payment_by_empty_carriage: str = Query(
        None, description="Тариф за порожний вагон (Сахалин)"
    ),
    crimea_payment_by_empty_carriage: str = Query(
        None, description="Тариф за порожний вагон (Крым)"
    ),
    kazakhstan_payment_by_empty_carriage: str = Query(
        None, description="Тариф за порожний вагон (Казахстан)"
    ),
    litva_payment_by_empty_carriage: str = Query(
        None, description="Тариф за порожний вагон (Литва)"
    ),
    belarus_payment_by_empty_carriage: str = Query(
        None, description="Тариф за порожний вагон (Беларусь)"
    ),
    zhdn_payment_by_empty_carriage: str = Query(
        None, description="Тариф за порожний вагон (ЖДН)"
    ),
    mainland_payment_distance: str = Query(
        None, description="Тарифное расстояние (материк)"
    ),
    sakhalin_payment_distance: str = Query(
        None, description="Тарифное расстояние (Сахалин)"
    ),
    crimea_payment_distance: str = Query(
        None, description="Тарифное расстояние (Крым)"
    ),
    kazakhstan_payment_distance: str = Query(
        None, description="Тарифное расстояние (Казахстан)"
    ),
    litva_payment_distance: str = Query(
        None, description="Тарифное расстояние (Литва)"
    ),
    belarus_payment_distance: str = Query(
        None, description="Тарифное расстояние (Беларусь)"
    ),
    zhdn_payment_distance: str = Query(None, description="Тарифное расстояние (ЖДН)"),
    mainland_currency_of_result: str = Query(
        None, description="Валюта результата (материк)"
    ),
    sakhalin_currency_of_result: str = Query(
        None, description="Валюта результата (Сахалин)"
    ),
    crimea_currency_of_result: str = Query(
        None, description="Валюта результата (Крым)"
    ),
    kazakhstan_currency_of_result: str = Query(
        None, description="Валюта результата (Казахстан)"
    ),
    litva_currency_of_result: str = Query(
        None, description="Валюта результата (Литва)"
    ),
    belarus_currency_of_result: str = Query(
        None, description="Валюта результата (Беларусь)"
    ),
    ...
    station_otpr_name_in_system: str = Query(
        None, description="Название станции отправления в системе"
    ),
    station_nazn_name_in_system: str = Query(
        None, description="Название станции назначения в системе"
    ),
    station_otpr_subject_RF: str = Query(
        None, description="Субъект РФ станции отправления"
    ),
    ...
    station_nazn_subject_RF: str = Query(
        None, description="Субъект РФ станции назначения"
    ),
...
def get_uniq_values_by_filter(
    ...
    unique_values = (
        result.with_entities(getattr(Corr, field))  # Выбираем ТОЛЬКО нужное поле
